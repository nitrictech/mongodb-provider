...
func (a *AzureExtensionProvider) Policy(ctx *pulumi.Context, parent pulumi.Resource, name string, config *deploymentspb.Policy) error {
	...
	return a.NitricAzurePulumiProvider.Policy(ctx, parent, name, &filteredConfig)
}
